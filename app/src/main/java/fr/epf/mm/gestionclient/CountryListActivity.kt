...
class CountryListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.sortByNameButton).setOnClickListener {
            adapter.sortCountriesBy("name", isAscending)
        }

        findViewById<Button>(R.id.sortByPopulationButton).setOnClickListener {
            adapter.sortCountriesBy("population", isAscending)
        }

        val sortOrderButton = findViewById<ImageButton>(R.id.sortOrderButton)
        sortOrderButton.setOnClickListener {
            isAscending = !isAscending
            updateSortOrderIcon(sortOrderButton)
            adapter.sortCountriesBy(adapter.currentSortCriterion, isAscending)
        }
    }
    ...
    private fun updateFilterButton() {
        if (showFavoritesOnly) {
            ...
            binding.filterFavoritesButton.text = "Favoris"
        }
    }

    private fun updateSortOrderIcon(button: ImageButton) {
        if (isAscending) {
